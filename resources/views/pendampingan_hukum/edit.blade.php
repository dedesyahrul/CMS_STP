        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('pendampingan_hukum.update', $pendampinganHukum) }}"
                        ...
                        <div class="form-group">
                            ...
                            <x-jet-input id="instansi" type="text" class="mt-1 block w-full" name="instansi"
                                :value="old('instansi', $pendampinganHukum->instansi)" required autofocus />
                        ...
                        <div class="form-group">
                            ...
                            <x-jet-input id="perihal" type="text" class="mt-1 block w-full" name="perihal"
                                :value="old('perihal', $pendampinganHukum->perihal)" required />
