    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h3 class="text-lg font-bold mb-4">Daftar Audit Hukum</h3>

                @if ($auditHukum->isEmpty())
                    <p>Tidak ada data audit hukum.</p>
                @else
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @php
                                $currentPage = $auditHukum->currentPage();
                                $perPage = $auditHukum->perPage();
                            ...
                            @foreach ($auditHukum as $p)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('kelola_audit_hukum.destroy', $p) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
